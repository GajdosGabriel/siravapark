...
class iContactApi {
     ...
     * @return object
     **/
    public function addContact($sEmail, $sStatus = 'normal', $sPrefix = null, $sFirstName = null, $sLastName = null, $sPassword = null, $sSuffix = null, $sStreet = null, $sStreet2 = null, $sCity = null, $sState = null, $sPostalCode = null, $sPhone = null, $sFax = null, $sBusiness = null) {
        // Valid statuses
        ...
        if (!empty($sPassword)) {
            ...
            $aContact['password'] = (string) $sPassword;
        }
        // Check for a suffix
        if (!empty($sSuffix)) {
            // Add the new suffix
