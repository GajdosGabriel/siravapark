<div id="mediaModal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document" style="font-size: 90%">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('public/news.title')</h5>
            ...
            <div class="modal-body">
                <div class="row justify-content-md-center pt-5">
                    ...
                    <div class="col-12 col-lg-3 xs-pb-50 lg-pb-0">
                        <img src="{{ asset('images/logo_tv_markiza.png') }}" style="margin-bottom: 18px;display: block;  margin-left: auto;  margin-right: auto; width: 32%;" alt="" class="lead text-center" data-aos="zoom-in">
                        ...
                        {{-- TRENDS.sk --}}
                        <img src="{{ asset('images/logo_trends.png') }}" style="margin-bottom: 18px;margin-top: 148px;display: block;  margin-left: auto;  margin-right: auto; width: 72%;" alt="" class="lead text-center" data-aos="zoom-in">

                        <div class="color_primary text-center font-weight-bold" style="font-size: 120%; ">
                            <a href="https://reality.etrend.sk/komercne-nehnutelnosti/investicia-za-miliony-cast-noveho-rekreacneho-arealu-na-sirave-maju-otvorit-toto-leto.html" target="_blank">@lang('public/news.news') 10.02.2020</a><br>
                        </div>
                    ...
                    <div class="col-12 col-lg-3 xs-pb-50 lg-pb-0">
                        ...
                        {{--<hr style="" class="part primary">--}}
                        <div class="color_primary text-center font-weight-bold" style="font-size: 120%; ">
                            <a href="https://index.sme.sk/c/22186310/na-vychode-kreslia-novu-dedinu-ma-pripominat-primorske-stredisko.html" target="_blank">@lang('public/news.news') 26.08.2019</a><br>
                        ...
                        {{-- ZOZNAM.sk --}}
                        <img src="{{ asset('images/logo_zoznam.png') }}" style="margin-bottom: 8px;margin-top: 145px;display: block;  margin-left: auto;  margin-right: auto; width: 72%;" alt="" class="lead text-center" data-aos="zoom-in">

                        <div class="color_primary text-center font-weight-bold" style="font-size: 120%; ">
                            <a href="https://www.topky.sk/cl/10/1860475/Velky-projekt-na-vychode-Slovenska--Rekreacny-komplex-za-sest-milionov" target="_blank">@lang('public/news.news') 13.02.2020</a><br>
                        </div>
                    </div>

                    {{-- RTVS --}}
                    <div class="col-12 col-lg-3 xs-pb-50 lg-pb-0">
                        <img src="{{ asset('images/logo_rtv.png') }}" style="margin-bottom: 26px;display: block;  margin-left: auto;  margin-right: auto;  width: 55%;" alt="" class="lead text-center" data-aos="zoom-in">
                        ...
                        <div class="color_primary text-center font-weight-bold" style="font-size: 120%; ">
                            ...
                            <span style="font-size: 85%">@lang('public/news.from') 44:00</span><br>
                        </div>

                        {{-- DNES 24 --}}
                        <img src="{{ asset('images/logo_dnes24.png') }}" style="margin-bottom: 6px;margin-top: 139px;display: block;  margin-left: auto;  margin-right: auto; width: 62%;" alt="" class="lead text-center" data-aos="zoom-in">

                        <div class="color_primary text-center font-weight-bold" style="font-size: 120%; ">
                            <a href="https://michalovce.dnes24.sk/pri-zemplinskej-sirave-planuju-rekreacny-komplex-za-sest-milionov-eur-353328" target="_blank">@lang('public/news.news') 10.02.2020</a><br>
                        </div>
