<h3 class="xs-mb-20 md-mb-30 font-lato">@lang('member/invest/step1.personal')</h3>
    ...
    <div class="col-xs-12 col-md-6">
        <div class="form-group required">
            ...
            <select id="country" name="country" class="form-control" required>
                ...
                {{ \App\Classes\Country::countries(old('country') ? old('country') : Auth::user()->country) }}
            </select>
        </div>
    </div>
    ...
    <div class="input-group">
        <span class="input-group-btn select">
            <select id="phone_code" name="phone_code" class="form-control" required>
                ...
                {{ \App\Classes\Country::phoneCodes(old('phone_code') ? old('phone_code') : Auth::user()->phone_code) }}
            </select>
        </span>
