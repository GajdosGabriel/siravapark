...
@section('projectName')
    Renovation project house 3
@endsection

@section('projectHeader')
    <a href="{{ route('member.realized.home') }}" class="link"><i class="fas fa-angle-left"></i> @lang('member/track.back')</a>

    <img src="{{ asset('images/member/realized/renovation_project_house3/cover.jpg') }}" alt="">
...
@section('projectContent')
    <div class="card">
        <div class="card-body">
            ...
            <a href="{{ asset('images/member/realized/renovation_project_house3/1.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/renovation_project_house3/sm/1.jpg') }}" class="img-fluid d-block w-100 xs-mb-20" alt=""></a>

            <div class="row xs-mt-20">
                <div class="col-4">
                    <a href="{{ asset('images/member/realized/renovation_project_house3/2.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/renovation_project_house3/sm/2.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/realized/renovation_project_house3/3.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/renovation_project_house3/sm/3.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/realized/renovation_project_house3/4.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/renovation_project_house3/sm/4.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>
            </div>
        </div>
    </div>
